...
3. Randomly generates what kind of animal type it is
...
//sorts and prints player rankings
...
/*
1. check for items array //if no weapons are detected, end function // if true, generate random number between 0-3, 
...
5. display hp stats
6. checks for valid percentage of mob drop when mob is dead
//loop ends
*/
