...
private:
    ...
    static const int max_mobs_ = 5;  // max non-player characters
    static const int max_villages_ = 1;
    static const int max_trees_ = 3;
    static const int max_animals_ = 2;
    static const int max_strongholds_ = 1;
    static const int max_caves_ = 1;
    //cave 
    static const int max_iron_ = 3;
    static const int max_gold_ = 2;
    static const int max_diamond_ = 1;
    //end dimension/map
